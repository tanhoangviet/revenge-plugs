...
function getPluginCopy(pluginId, manifest, files) {
    ...
    if (pluginId === "Ios26Discord") {
        return {
            plugindetailsubtitle: `${description} It reshapes Discord with liquid glass panels, glass cards, quick actions, and a floating Dynamic Island.`,
  ...
  motion: "liquid"
            ...
            featureintro: "The plugin adds a liquid glass visual layer across Discord while turning Dynamic Island into a quick action surface.",
            feature1label: "Island",
            feature1title: "Dynamic Island that actually does things.",
            feature1body: "Tap the island to open search, slash command, Spotify, and YouTube actions without leaving the chat surface.",
            feature2label: "Media",
            feature2title: "Spotify and YouTube float controls.",
            feature2body: "Paste a link or type a query, then launch Spotify or YouTube with a floating glass media panel left behind in Discord.",
            feature3label: "Cards",
            feature3title: "Glass attachment surfaces.",
            feature3body: "Rich links and attachment cards get softer borders, iOS-like radius, and accent-aware colors.",
            ...
            cardpill1: "Quick Search",
            cardpill2: "Media float",
